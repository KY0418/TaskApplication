...
@router.get("/importance",response_model=list[importance_schema.importanceResponse])
...
@router.get("/importance/{searchid}",response_model=list[importance_schema.importanceResponse])
